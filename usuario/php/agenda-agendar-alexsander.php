...
<main class="container mt-5">
    ...
    <?php 
        ...
        echo "<form action='./agenda-salvar-alexsander.php?id={$l['id']}' method='post' class='needs-validation' novalidate style='background: #ecf0f1; padding: 20px; border-radius: 8px;'>";
            ...
            $sql = "SELECT * FROM agenda_alexsander";
            $res = mysqli_query($conexao, $sql);
            $reservados = [];
            while ($l = mysqli_fetch_assoc($res)) {
                $reservados[] = [
