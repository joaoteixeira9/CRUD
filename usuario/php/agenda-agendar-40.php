<?php
    ...
    <?php 
        ...
        echo "<form action='./agenda-salvar-40.php?id={$l['id']}' method='post' class='needs-validation' novalidate style='background: #ecf0f1; padding: 20px; border-radius: 8px;'>";
